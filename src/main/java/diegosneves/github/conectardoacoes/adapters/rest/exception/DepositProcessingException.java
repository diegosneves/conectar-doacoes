...
/**
 * A classe {@link DepositProcessingException} representa uma exceção específica que será lançada
 ...
 * @since 1.3.0
 */
public class DepositProcessingException extends CustomException {

    /**
     * Construtor da exceção {@link DepositProcessingException}.
     * <p>
     * Este construtor cria uma instância de {@link DepositProcessingException} usando um termo específico.
     ...
     */
    public DepositProcessingException(Integer term) {
     ...
     */
    public DepositProcessingException(Integer term, String message) {
     ...
     */
    public DepositProcessingException(Integer term, String message, Throwable cause) {
