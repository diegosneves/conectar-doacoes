 ...
 * é inicializada com o valor {@link ExceptionDetails#USER_CREATION_ERROR USER_CREATION_ERROR}.
 * <p>
...
public class UserCreationFailureException extends RuntimeException {
    ...
    public static final ExceptionDetails ERROR = ExceptionDetails.USER_CREATION_ERROR;
